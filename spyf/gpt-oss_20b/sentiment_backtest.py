...
Скрипт читает настройки из единого `spyf/settings.yaml`, загружает
...
sys.path.insert(1, str(TICKER_DIR.parent.parent))
...
def main(
    ...
    model_name = str(settings.get("sentiment_model", "gpt-oss:20b"))
