"""
Торговый оркестратор всех модельных пайплайнов для тикера SPYF.
...
После успешной подготовки скрипт находит в подпапках `spyf/<model>/` файлы `run_trade.py`
...
запускает combine-пайплайн в `spyf/combine/run_trade.py` (если папка есть):
...
Запуск:
python spyf/run_spyf_trade.py
python spyf/run_spyf_trade.py --only gemma3_12b,gemma4_e2b --keep-going
python spyf/run_spyf_trade.py --keep-going
"""
