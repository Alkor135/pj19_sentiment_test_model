...
запускает combine-пайплайн в `spyf/combine/` (если эта папка есть):
...
Запуск:
python spyf/run_spyf.py
python spyf/run_spyf.py --only gemma3_12b,gemma4_e2b,gemma4_e4b,qwen2.5_14b,qwen2.5_7b,qwen3_14b --keep-going
python spyf/run_spyf.py --keep-going  «продолжать дальше»
"""
...
app = typer.Typer(help="Последовательный запуск пайплайнов всех моделей SPYF.")
...
def main(
    ...
    """Прогоняет пайплайны всех моделей SPYF или подмножества по --only."""
