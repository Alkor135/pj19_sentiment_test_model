"""
Торговый оркестратор всех модельных пайплайнов для тикера NG.
...
После успешной подготовки скрипт находит в подпапках `ng/<model>/` файлы `run_trade.py`
...
запускает combine-пайплайн в `ng/combine/run_trade.py` (если папка есть):
...
Запуск:
python ng/run_ng_trade.py
python ng/run_ng_trade.py --only gemma3_12b,gemma4_e2b --keep-going
python ng/run_ng_trade.py --keep-going
"""
