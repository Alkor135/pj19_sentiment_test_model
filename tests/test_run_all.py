...
def test_run_all_groups_model_steps_by_ticker() -> None:
    ...
    assert run_all.HARD_STEPS.index(mix_trade) < run_all.HARD_STEPS.index(si_analysis)
    assert run_all.HARD_STEPS.index(si_analysis) < run_all.HARD_STEPS.index(si_trade)
    assert run_all.HARD_STEPS.index(si_trade) < run_all.HARD_STEPS.index(ng_analysis)
